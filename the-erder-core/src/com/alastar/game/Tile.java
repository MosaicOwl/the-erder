...
public class Tile extends Transform implements Serializable, TexturedObject {
    ...
    {
        batch.draw(this.getTexture(), this.position.x * GameManager.textureResolution, this.position.y * GameManager.textureResolution + this.position.z * GameManager.textureResolution);
    }
    ...
    {
        return new Rectangle(this.position.x * GameManager.textureResolution, this.position.y * GameManager.textureResolution + this.position.z * GameManager.textureResolution, GameManager.textureResolution, GameManager.textureResolution);
    }
